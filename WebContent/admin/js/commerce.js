...
//毛利率转换
function getRate(e) {
    if (e.data.profitrmb === null || e.data.amountar === null) {
        return '0.00%';
    } else if (e.data.profitrmb === 0 || e.data.amountar === 0) {
        return '0.00%';
    } else {
        e.data.rate = Number(e.data.profitrmb / e.data.amountar * 100).toFixed(2) + '%';
        return e.data.rate;
    }
}

//毛利率转换
function getBaseRate(e) {
    if (e.data.baseprofitrmb === null || e.data.baseamountar === null) {
        return '0.00%';
    } else if (e.data.baseprofitrmb === 0 || e.data.baseamountar === 0) {
        return '0.00%';
    } else {
        e.data.baserate = Number(e.data.baseprofitrmb / e.data.baseamountar * 100).toFixed(2) + '%';
        return e.data.baserate;
    }
}
